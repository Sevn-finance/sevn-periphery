...
import ISevnV2Pair from '../build/ISevnPair.json'
...
import {bytecode } from '../build_core/SevnPair.json'
...
describe('SevnV2Router02', () => {
  ...
  it('getAmountOut', async () => {
    ...
    await expect(router.getAmountOut(bigNumberify(0), bigNumberify(100), bigNumberify(100), swapFee)).to.be.revertedWith(
      'SevnLibrary: INSUFFICIENT_INPUT_AMOUNT'
    )
  ...
  it('getAmountIn', async () => {
    ...
    await expect(router.getAmountIn(bigNumberify(0), bigNumberify(100), bigNumberify(100), swapFee)).to.be.revertedWith(
      'SevnLibrary: INSUFFICIENT_OUTPUT_AMOUNT'
    )
...
describe('fee-on-transfer tokens', () => {
  ...
  beforeEach(async function() {
    ...
    pair = new Contract(pairAddress, JSON.stringify(ISevnV2Pair.abi), provider).connect(wallet)
  })
